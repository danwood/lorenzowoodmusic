...
var targetOffset = $("#hero-covered").offset().top;

var $w = $(window).scroll(function(){
    if ( $w.scrollTop() > targetOffset ) {
        $('.hero').css({"filter":"grayscale(0%)"});
    }
});
...
$('#lightweight_widget').html('<iframe src="http://lightwidget.com/widgets/9b560c45f4e75b9f93dd8bcca23a28a3.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width: 100%; border: 0; overflow: hidden; margin-top:0"></iframe>');
