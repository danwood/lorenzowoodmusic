...
<meta name='twitter:image' content='<?php echo baseURL() . '/album_art_1200x630/' . htmlentities($release['imageName'], ENT_QUOTES); ?>'><link rel="stylesheet" href="/css/linkstyles.050920.css"></head><body><!--[if lt IE 9]><p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please
<a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p><![endif]--><header id="main-header"><div class="logo"><a href="/"><h1>Lorenzo Wood</h1></a><div class="mini-icons"><a data-title="Instagram" href="https://instagram.com/LorenzoWoodMusic" style="fill:#e95950"><svg><use xlink:href="/svg/homepage.svg#instagram"></use></svg></a><a data-title="Facebook" href="https://facebook.com/LorenzoWoodMusic" style="fill:#3b5998"><svg><use xlink:href="/svg/homepage.svg#facebook"></use></svg></a></div><input id="navigation" type="checkbox"><label class="hamburger" for="navigation"><div class="spinner diagonal part-1"></div><div class="spinner horizontal"></div><div class="spinner diagonal part-2"></div></label><nav class="page-menu"><ul><li><a href="/">home</a></li><li><a href="/photos/">photos</a></li><li><a href="/videos/">videos</a></li><li><a href="/booking/">booking</a></li><li><a href="/2am-in-the-basement/">2am</a></li></ul></nav></div><?php if ($genBlurhash) { ?>
...
<canvas id="outputCanvas" style="display:none" width="32" height="32"></canvas></div><div class="background-blur"><img src="<?php $blur = $release['image_blurred'] ? '../blurred_100/' . $release['image_blurred'] : '../album_art_640/' . htmlentities($release['image']); echo htmlentities($blur, ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div><div class="center-column"><?php if ($release['blurb']) { ?>
...
<?php } ?><h1><?php echo htmlspecialchars($release['artist_name']); ?> <br> <?php echo htmlspecialchars($release['title']); ?></h1><?php $featuring = $release['featuring']; if (!empty($featuring)) { echo ' (Featuring ' . htmlspecialchars($featuring) . ')'; } ?></div><div class="imagecontainer"><img src="../album_art_640/<?php echo htmlentities($release['image'], ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div><div class="title-container"><h2><?php
if ($now < $releaseDate) {
...
<div class="service"><a href="https://geo.itunes.apple.com/us/album/<?php echo htmlentities($release['apple_music_album'], ENT_QUOTES); ?>?app=itunes&amp;at=1000lKSp"><svg><use xlink:href="/svg/linkpage.svg#itunes" /></svg><span class="play"><?php echo ($now < $releaseDate) ? 'Pre-order' : 'Download'; ?></span></a></div>
<?php } if ($release['apple_music_album'] && ($now >= $releaseDate)) { ?>
<div class="service"><a href="https://geo.itunes.apple.com/us/album/<?php echo htmlentities($release['apple_music_album'], ENT_QUOTES); ?>?mt=1&app=music&amp;at=1000lKSp"><svg><use xlink:href="/svg/linkpage.svg#apple-music" /></svg><span class="play">Play</span></a></div>
...
$db->close();
?><script src="/js/svg4everybody.min.js"></script><script>svg4everybody();</script><script>document.documentElement.className = document.documentElement.className.replace("no-js","js");</script></body></html>