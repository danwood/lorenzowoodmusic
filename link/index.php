...
<a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p><![endif]--><header id="main-header"><div class="logo"><a href="/"><h1>Lorenzo Wood</h1></a><div class="mini-icons"><div class="icon"><a data-title="Instagram" href="https://instagram.com/LorenzoWoodMusic"><svg><use xlink:href="/svg/homepage.svg#instagram"></use></svg></a></div><div class="icon"><a data-title="Facebook" href="https://facebook.com/LorenzoWoodMusic"><svg><use xlink:href="/svg/homepage.svg#facebook"></use></svg></a></div></div><input id="navigation" type="checkbox"><label class="hamburger" for="navigation"><span class="spinner diagonal part-1"></span><span class="spinner horizontal"></span><span class="spinner diagonal part-2"></span></label><nav class="page-menu"><ul><li><a href="/">home</a></li><li><a href="/photos/">photos</a></li><li><a href="/videos/">videos</a></li><li><a href="/booking/">booking</a></li><li><a href="/2am-in-the-basement/">2am</a></li></ul></nav></div><?php if ($genBlurhash) { ?>
...
<canvas id="outputCanvas" style="display:none" width="32" height="32"></canvas></div><div class="background-blur" id="background-blur"><noscript><img src="<?php $blur = CLOUDPREFIX . ($release['image_blurred'] ? 'blurred_100/' . $release['image_blurred'] : 'album_art_640/' . htmlentities($release['image'])); echo htmlentities($blur, ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></noscript></div><div class="center-column"><?php if ($release['blurb']) { ?>
...
<?php } ?><h1><?php echo htmlspecialchars($release['artist_name']); ?> <br> <?php echo htmlspecialchars($release['title']); ?></h1><?php $featuring = $release['featuring']; if (!empty($featuring)) { echo ' (Featuring ' . htmlspecialchars($featuring) . ')'; } ?></div><div class="imagecontainer"><img width="640" height="640" src="<?php echo CLOUDPREFIX . 'album_art_640/' . htmlentities($release['image'], ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div><div class="title-container"><h2><?php
if ($now < $releaseDate) {
