...
<meta name='twitter:image' content='<?php echo baseURL() . '/album_art_large/' . htmlentities($album['imageName'], ENT_QUOTES); ?>'><link rel="stylesheet" href="link.css"></head><body><!--[if lt IE 9]><p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please
