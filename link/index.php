...
<div class="youtube-border"><div class="youtube" data-popup="yep" data-embed='<?php echo htmlentities($album['youtube_video_id'], ENT_QUOTES); ?>:'></div></div>
<?php } ?>
        </div>
        <div class="title-container">
          <p>
