...
<?php } ?><div class="title-container"><?php if ($release['youtube_video_v']) { ?>
...
<?php } ?><h1><?php echo htmlspecialchars($release['artist_name']); ?> <br> <?php echo htmlspecialchars($release['title']); ?></h1><?php $featuring = $release['featuring']; if (!empty($featuring)) { echo ' (Featuring ' . htmlspecialchars($featuring) . ')'; } ?></div><div class="imagecontainer"><img src="<?php echo CLOUDPREFIX . 'album_art_640/' . htmlentities($release['image'], ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div><div class="title-container"><h2><?php
if ($now < $releaseDate) {
...
<div class="service"><a href="https://play.google.com/store/music/album/<?php echo htmlentities($release['google_play_album'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#google-play" /></svg><span class="play"><?php echo ($now < $releaseDate) ? 'Pre-order' : 'Download'; ?></span></a></div>
...
<?php } ?>
<?php } ?></div></div></main><footer><p><b>Copyright © 2017-2020 Lorenzo Wood</b><span class="widespace"></span><span class="widespace"></span>
