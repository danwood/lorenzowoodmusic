...
<html class="no-js" lang="en-us">
  <head>
    ...
    <link rel="prefetch" href="//res.cloudinary.com?ckcachebust=620105104">
    <link rel="prefetch" href="//fonts.googleapis.com"><title><?php echo htmlentities($longTitle); ?></title><?php if (strlen($descriptionText) > 0) { echo "<meta name='description' content='" . htmlentities($descriptionText, ENT_QUOTES) . "'>"; } ?>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover">
    <meta name="supported-color-schemes" content="light dark">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,800&amp;display=swap&amp;subset=latin" rel="stylesheet">
    <link rel="apple-touch-icon" sizes="180x180" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/apple-touch-icon.png?ckcachebust=620105104">
    <link rel="icon" type="image/png" sizes="32x32" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/favicon-32x32.png?ckcachebust=620105104">
    <link rel="icon" type="image/png" sizes="16x16" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/favicon-16x16.png?ckcachebust=620105104">
    <link rel="stylesheet" href="/css/main.082520.css?ckcachebust=620105104"><meta property='og:title' content='<?php echo htmlentities($longTitle, ENT_QUOTES); ?>'>
    ...
    <header id="main-header">
      <div class="logo"><a href="/">
        ...
        <div class="mini-icons">
          <div class="icon"><a data-title="Instagram" href="https://instagram.com/LorenzoWoodMusic">
              <svg>
                <use xlink:href="/svg/homepage.svg#instagram"></use>
              </svg></a></div>
          <div class="icon"><a data-title="Facebook" href="https://facebook.com/LorenzoWoodMusic">
              <svg>
                <use xlink:href="/svg/homepage.svg#facebook"></use>
              </svg></a></div>
        </div>
        <input id="navigation" type="checkbox">
        <label class="hamburger" for="navigation"><span class="spinner diagonal part-1"></span><span class="spinner horizontal"></span><span class="spinner diagonal part-2"></span></label>
        <nav class="page-menu">
          <ul>
                    <li><a href="/">home</a></li>
...
<canvas id="originalCanvas" style="display:none" width="100" height="100"></canvas>
<?php } ?>
    </header>
    <main>
      <div class="blurhash"><img id="blurhashImage" />
<canvas id="outputCanvas" style="display:none" width="32" height="32"></canvas>
      </div>
      <div class="background-blur" id="background-blur">
        <noscript><img src="<?php $blur = CLOUDPREFIX . ($release['image_blurred'] ? 'blurred_100/' . $release['image_blurred'] : 'album_art_640/' . htmlentities($release['image'])); echo htmlentities($blur, ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></noscript>
      </div>
      <div class="center-column"><?php if ($release['blurb']) { ?>
...
<?php } ?>
        <div class="title-container"><?php if ($release['youtube_video_v']) { ?>
...
<?php } ?>
          <h1><?php echo htmlspecialchars($release['artist_name']); ?> <br> <?php echo htmlspecialchars($release['title']); ?></h1><?php $featuring = $release['featuring']; if (!empty($featuring)) { echo ' (Featuring ' . htmlspecialchars($featuring) . ')'; } ?>
        </div>
        <div class="imagecontainer"><img width="640" height="640" src="<?php echo CLOUDPREFIX . 'album_art_640/' . htmlentities($release['image'], ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div>
...
<div class="service"><a href="https://geo.itunes.apple.com/us/album/<?php echo htmlentities($release['apple_music_album'], ENT_QUOTES); ?>?app=itunes&amp;at=1000lKSp"><img src="../svg/linkpage/itunes.svg" alt="iTunes"><span class="play"><?php echo ($now < $releaseDate) ? 'Pre-order' : 'Download'; ?></span></a></div>
<?php } if ($release['apple_music_album'] && ($now >= $releaseDate)) { ?>
<div class="service"><a href="https://geo.itunes.apple.com/us/album/<?php echo htmlentities($release['apple_music_album'], ENT_QUOTES); ?>?mt=1&app=music&amp;at=1000lKSp"><img src="../svg/linkpage/apple-music.svg" alt="iTunes"><span class="play">Play</span></a></div>
<?php } if ($release['spotify_track']) { ?>
<div class="service"><a href="https://play.spotify.com/track/<?php echo htmlentities($release['spotify_track'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#spotify-text" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['spotify_album'] && !$release['spotify_track']) { ?>
<div class="service"><a href="https://play.spotify.com/album/<?php echo htmlentities($release['spotify_album'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#spotify-text" /></svg><span class="play">Play</span></a></div>
<?php } if ( (!$release['spotify_album']) && (!$release['spotify_track']) &&$release['spotify_presave_url']) { ?>
<div class="service"><a rel="nofollow" href="<?php echo htmlentities($release['spotify_presave_url'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#spotify-text" /></svg><span class="play">Pre-save</span></a>
<div	style="padding-left:5em; font-size:80%; color:gray"><?php 	if ($now >= $releaseDate) { ?>
          ...
          </div><?php } if ($now >= $releaseDate) { ?>
<?php      if ($release['amazon_dp']) { ?>
<div class="service"><a href="https://www.amazon.com/dp/<?php echo htmlentities($release['amazon_dp'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#amazon-music" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['youtube_music_v']) { ?>
<div class="service"><a href="https://music.youtube.com/watch?v=<?php echo htmlentities($release['youtube_music_v'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#youtube-music" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['youtube_music_MPRE'] && !$release['youtube_music_v']) { ?>
<div class="service"><a href="https://music.youtube.com/browse/<?php echo htmlentities($release['youtube_music_MPRE'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#youtube-music" /></svg><span class="play">Play</span></a></div>
...
<div class="service"><a href="https://www.deezer.com/us/track/<?php echo htmlentities($release['deezer_track'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#deezer" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['deezer_album'] && !$release['deezer_track']) { ?>
<div class="service"><a href="https://www.deezer.com/us/album/<?php echo htmlentities($release['deezer_album'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#deezer" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['iheartradio_songs']) { ?>
<div class="service"><a href="https://www.iheart.com/artist/lorenzo-wood-32159981/songs/<?php echo htmlentities($release['iheartradio_songs'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#iheartradio" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['tidal_track']) { ?>
<div class="service"><a href="https://listen.tidal.com/track/<?php echo htmlentities($release['tidal_track'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#tidal" /></svg><span class="play">Play</span></a></div>
<?php } if ($release['tidal_album'] && !$release['tidal_track']) { ?>
<div class="service"><a href="https://listen.tidal.com/album/<?php echo htmlentities($release['tidal_album'], ENT_QUOTES); ?>"><svg><use xlink:href="/svg/linkpage.svg#tidal" /></svg><span class="play">Play</span></a></div>
...
<?php } // end if now > release date ?>
        </div><?php if (strlen($descriptionText) > 0) { echo '<div class="blurb">' . $descriptionHTML . '</div>'; } ?>
      </div>
    </main>
    <footer>
      <p><b>Copyright © 2017-2020 Lorenzo Wood</b><span class="widespace"></span><span class="widespace"></span>
        <a class="contact-link" href="/contact/">Contact us</a><span class="widespace"></span>
        <a class="press-link" href="/press/">Press & Media</a>
      </p>
      <p class="js-warning">
        <noscript>
