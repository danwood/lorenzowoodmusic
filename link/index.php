...
<html class="no-js" lang="en-us">
  <head>
    ...
    <link rel="prefetch" href="//res.cloudinary.com?ckcachebust=620099184">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/apple-touch-icon.png?ckcachebust=620099184">
    <link rel="icon" type="image/png" sizes="32x32" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/favicon-32x32.png?ckcachebust=620099184">
    <link rel="icon" type="image/png" sizes="16x16" href="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/favicon-16x16.png?ckcachebust=620099184">
    <link rel="stylesheet" href="/css/main.082520.css?ckcachebust=620099184"><meta property='og:title' content='<?php echo htmlentities($longTitle, ENT_QUOTES); ?>'>
...
<meta name='twitter:image' content='<?php echo baseURL() . '/album_art_1200x630/' . htmlentities($release['imageName'], ENT_QUOTES); ?>'>
...
<canvas id="outputCanvas" style="display:none" width="32" height="32"></canvas>
      ...
      <div class="background-blur"><img src="<?php $blur = CLOUDPREFIX . ($release['image_blurred'] ? 'blurred_100/' . $release['image_blurred'] : 'album_art_640/' . htmlentities($release['image'])); echo htmlentities($blur, ENT_QUOTES); ?>" alt="<?php echo htmlentities($release['title'], ENT_QUOTES); ?>"></div>
