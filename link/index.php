...
<meta name='twitter:image' content='<?php echo baseURL() . '/album_art_1200x630/' . htmlentities($release['imageName'], ENT_QUOTES); ?>'><link rel="stylesheet" href="/css/linkstyles.051320.css"></head><body><!--[if lt IE 10]><p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please
