...
.background-blur, .blurhash {
  ...
  .background-blur img, .blurhash img {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
.switch {
  ...
  .switch .switch-selection {
    ...
    box-shadow: inset 0 1px rgba(255, 255, 255, 0.5), 0 0 2px rgba(0, 0, 0, 0.2); } </style></head><body><!--[if lt IE 10]><p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please
