...
<span style="opacity:0.3">(translated from Swedish)</span></footer></blockquote><blockquote>I love how this song conveys the underlying anxieties of a crush; the vocals are very smooth, but accompanied by a faster beat, which mimics the way your heart might beat faster around someone despite your normal behavior.<footer><a href="https://www.unheardgems.com/post/more-than-friends-lorenzo-wood-review">Unheard Gems</a></footer></blockquote><p>Featured on <a href="https://alfitude.com/2020/05/01/new-music-lorenzo-wood/">Alfitude New Music</a>.


</p><h2>Web Page</h2><p>Please use this URL to link to "<?php echo htmlspecialchars($release['title']); ?>":
<a href='https://www.lorenzowoodmusic.com/link/<?php echo htmlspecialchars($release['slug']); ?>'> https://www.lorenzowoodmusic.com/link/<?php echo htmlspecialchars($release['slug']); ?></a></p><div class="clearfix"><h2>Album Artwork</h2><a href='<?php echo htmlentities($db->pathCDNForImageSize($release, 3000), ENT_QUOTES); ?>'>
...
</a><div class="column"><p>Link to large image (3000 pixels square):<br><a href='<?php echo htmlentities($db->pathCDNForImageSize($release, 3000), ENT_QUOTES); ?>'>https://lorenzowoodmusic.com<?php echo htmlspecialchars($db->pathCDNForImageSize($release, 3000)); ?></a></p><p>Designed by
...
<b>(Explicit lyrics)</b></p><p class="soundCloudLink"><a href="https://soundcloud.com/lorenzowoodmusic/more-than-friends-clean-version/s-nX1HoYzNcUN"><img src="/svg/soundcloud-icon.svg" alt="">https://soundcloud.com/lorenzowoodmusic/more-than-friends-clean-version/s-nX1HoYzNcUN</a>
<b>(Radio Edit)</b></p><?php } ?><h2>Lyrics</h2><pre class="lyrics">I woke up at 5 a.m.
Just to talk to you
