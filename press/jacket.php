...
<a href='https://www.lorenzowoodmusic.com/link/<?php echo htmlspecialchars($release['slug']); ?>'> https://www.lorenzowoodmusic.com/link/<?php echo htmlspecialchars($release['slug']); ?></a></p><h3>Additional Links</h3><p><a class="spotify" href="https://open.spotify.com/artist/1BGQD9MGL3oUkS4sN86Wec">Aendru</a> on Spotify; his song <a href="https://open.spotify.com/track/52ybpfalBibR8F2qIGGggv">You and Me Now</a>.</p><p><a href="https://www.kaiasongs.com">Kaia homepage</a>.</p><div class="clearfix"><h2>Album Artwork</h2><a href='<?php echo htmlentities($db->pathCDNForImageSize($release, 3000, false), ENT_QUOTES); ?>'>
...
</a><a href="../album_art_3000/jacket-ep.jpg"><img class="cover" src="https://res.cloudinary.com/avfivcfiwkvgmspufqrh/image/upload/lwm/album_art_384/jacket-ep.jpg"></a><div class="column"><p>Link to large image (3000 pixels square):<br><a href='<?php echo htmlentities($db->pathCDNForImageSize($release, 3000, false), ENT_QUOTES); ?>'>https://www.lorenzowoodmusic.com<?php echo htmlspecialchars($db->pathCDNForImageSize($release, 3000, false)); ?></a></p><p><a href="../album_art_3000/jacket-ep.jpg">Link to second large image (3000 pixels square)</a></p><p>Designed by
