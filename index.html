...
<html class="no-js" lang="en-us">
  ...
  <body><!--[if lt IE 9]>
    ...
    <main>
      <section class="bio">
        ...
        <article class="textual">
          <p>
            Lorenzo Wood is a young musician from Alameda, California USA. He sings, plays guitar, drums,
            piano/keyboards, bass, and a bit of ukulele. He also beat-boxes, and uses a Loop Station for
            live performances. He writes or co-writes many of his own original songs. He produces and
            records his music (using Apple Logic) and creates live performance videos.
          </p>
          <p>
            Lorenzo started learning to play the drums at the age of four. At the age of seven, he
            ...
            lessons. He is entirely self-taught on guitar.
          </p>
          <p>
            Lorenzo lists
      ...
      <section class="instagram-section requires-js maximize-mobile">
        ...
        <footer>
          <h3><a href="https://instagram.com/LorenzoWoodMusic">More from Instagram</a></h3>
        </footer>
      </section>
      <section class="soundcloud-section balance-footer requires-js maximize-mobile">
        ...
        <footer>
          <h3><a href="https://soundcloud.com/LorenzoWoodMusic">More from SoundCloud</a></h3>
        </footer>
      </section>
        ...
        <article class="clearfix">
          <div class="youtube-column">
            <div class="embed-container">
              <iframe src="https://www.youtube.com/embed/ipoL1h1d7zA" allowfullscreen></iframe>
            </div>
          </div>
          <div class="youtube-column">
            <div class="embed-container">
              <iframe src="https://www.youtube.com/embed/RynQ3nswXyk" allowfullscreen></iframe>
            </div>
          </div>
        </article>
        <footer>
          <h3><a href="https://www.youtube.com/lorenzowoodmusic">More from YouTube</a></h3>
        </footer>
      </section>
      <section class="track-section">
        <article class="textual clearfix">
          <div class="track-photo"><img src="img/side.jpg" alt="Lorenzo singing, viewed from the side"></div>
          <div class="track-form">
            <div class="track-form-padded">
              <h2>Subscribe to Lorenzo's mailing list</h2>
              <p>We also suggest tracking Lorenzo on <a href="https://bandsintown.com/lorenzowoodmusic">BandsInTown</a>.</p>
              <form class="validate" action="https://lorenzowoodmusic.us16.list-manage.com/subscribe/post?u=3fb2f947fceaaa94b99d40919&amp;id=1c68d63e9a" method="post" name="mc-embedded-subscribe-form" target="_blank">
                <div>
    ...
    <script>"0px"===$("section, .safe-area").css("padding-left")&&($("section, .safe-area").css("padding-left","1em"),$("section, .safe-area").css("padding-right","1em"));var targetOffset=$(".popular").offset().top,$w=$(window).scroll(function(){$w.scrollTop()>targetOffset&&$(".hero img").css({filter:"grayscale(0%)"})});window.lightwidget||(window.lightwidget=function(){"use strict";var e=[],t=0,i=!1,n=["lightwidget.com","instansive.com","dev.lightwidget.com"],o=function(e){return i=e},s=function(e,t){e.contentWindow&&e.contentWindow.postMessage("sizing:"+t,window.location.protocol+"//lightwidget.com")},d=function(t){var i=t.origin.replace(/^https?\:\/\//i,"");if(-1!==n.indexOf(i)){var o=t.data.split(":");try{"sizing"==o[0]&&void 0!=e[parseInt(o[2])]&&(e[parseInt(o[2])].style.height=o[1]+"px")}catch(e){}}},c=function(e){i&&console.log(e);var t=e.origin.replace(/^https?\:\/\//i,"");if(-1!==n.indexOf(t)){var o=e.data.split(":");i&&console.log(o);try{if("sizing_iid"==o[0]){var s=o[2],d=s.replace("instansive_","").replace("lightwidget_");void 0!==document.querySelectorAll('iframe[src*="lightwidget.com/widgets/'+d+'"]')[0]?(i&&console.log("iframesrc"),document.querySelectorAll('iframe[src*="lightwidget.com/widgets/'+d+'"]')[0].style.height=o[1]+"px"):void 0!=document.getElementById(s)?document.getElementById(s).style.height=o[1]+"px":(s=s.replace("instansive","lightwidget"),void 0!=document.getElementById(s)&&(document.getElementById(s).style.height=o[1]+"px"))}}catch(e){i&&console.log(e)}}},a=function(e){i&&console.log("json",e);var t=e.origin.replace(/^https?\:\/\//i,"");if(-1!==n.indexOf(t))try{var o=JSON.parse(e.data);"lightwidget_widget_size"===o.type&&o.size>0&&(void 0!==document.querySelectorAll('iframe[src*="lightwidget.com/widgets/'+o.widgetId+'"]')[0]?document.querySelectorAll('iframe[src*="lightwidget.com/widgets/'+o.widgetId+'"]')[0].style.height=o.size+"px":void 0!==document.querySelectorAll('iframe[src*="instansive.com/widgets/'+o.widgetId+'"]')[0]&&(document.querySelectorAll('iframe[src*="instansive.com/widgets/'+o.widgetId+'"]')[0].style.height=o.size+"px"))}catch(t){i&&console.log(t,e.data)}},r=function(){window.addEventListener?(window.addEventListener("message",d,!1),window.addEventListener("message",c,!1),window.addEventListener("message",a,!1)):(window.attachEvent("onmessage",d),window.attachEvent("onmessage",c),window.attachEvent("onmessage",a))};return r(),{refresh:function(){if(!1)for(var t=0;t<0;t++)s(e[t],t)},reload:function(){r()},debug:function(e){return o(e)}}}()),window.lightwidget.refresh(),$("#lightweight_widget").html('<iframe src="http://lightwidget.com/widgets/9b560c45f4e75b9f93dd8bcca23a28a3.html" scrolling="no" allowtransparency="true" class="lightwidget-widget"></iframe>'),document.documentElement.className=document.documentElement.className.replace("no-js","js");</script>
