...
error, please contact webmaster@lorenzowoodmusic.com with the code that you used.</p><?php die; } ?><div id="redeem_console"><h1><?php echo htmlspecialchars($album['title']); ?></h1><p><?php echo htmlspecialchars($album['description']); ?></p><div id="cover-art-container"><div id="cover-art"><img src="/album_art/<?php echo htmlspecialchars($album['imageName']); ?>" alt="<?php echo htmlspecialchars($album['title']); ?>"></div></div><form id="downloader"><input type="hidden" id="a_input" name="a" value="<?php echo $album['ID']; ?>"><input type="hidden" id="c_input" name="c" value="<?php echo $code; ?>"><?php
if ($iOSDevice) {
