...
<html class="no-js" lang="en-us">
  ...
  <body><!--[if lt IE 9]>
    ...
    <header>
      ...
      <div class="hero">
        <picture>
          <source srcset="img/hero.webp" type="image/webp"><img src="img/hero.jpg" alt="Lorenzo Wood">
        </picture>
      </div>
    ...
    <main>
      ...
      <section class="patreon-section">
        <article class="textual">
          ...
          <p>
            Patreon is an online system where you can become a “patron” or sponsor of up-and-coming content creators you like through ongoing support and funding. Click the button above and find out how you can support Lorenzo's creativity.
      ...
      <section class="youtube-section balance-footer requires-js maximize-mobile">
        ...
        <article class="clearfix">
          <div class="youtube-column">
            <div class="youtube" data-embed="ipoL1h1d7zA:Keith Urban — Female (Loop cover)"></div>
          </div>
          <div class="youtube-column">
            <div class="youtube" data-embed="RynQ3nswXyk:Shawn Mendes - Ruin (Lorenzo Wood Cover)"></div>
          </div>
        </article>
        <footer>
      ...
      <section class="track-section">
        <article class="textual clearfix">
          <div class="track-photo">
            <picture>
              <source srcset="img/side.webp" type="image/webp"><img src="img/side.jpg" alt="Lorenzo singing, viewed from the side">
            </picture>
          </div>
          <div class="track-form input-form">
      ...
      <section class="contact">
        ...
        <article class="textual">
          <div class="input-form">
            <form id="contact-form" action="https://jumprock.co/mail/lozobooking" method="post">
              ...
              <div>
                <textarea type="text" id="message" name="message" rows="10" cols="40" required="required"></textarea>
              </div>
              <div>
                <input class="trapit" type="text" name="trapit">
