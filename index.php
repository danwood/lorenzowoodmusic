...
var targetOffset = document.querySelector('main').getBoundingClientRect().top;
...
var lightWidget = document.querySelector('#lightweight_widget');
lightWidget.innerHTML = '<iframe src="https://lightwidget.com/widgets/9b560c45f4e75b9f93dd8bcca23a28a3.html" scrolling="no" allowtransparency="true" class="lightwidget-widget"></iframe>';
...
</script><!--script(src="CACHE/bandsintown.js")//- Cached on server from https://widget.bandsintown.com/main.min.js--></body></html>